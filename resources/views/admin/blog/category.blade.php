                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between g-3">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Blog Category</h3>
                                        <div class="nk-block-des text-soft">
                                            <p>Categories for Blog Posts.</p>
                                        </div>
                                        ...
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    <li class="nk-block-tools-opt"><a href="{{ route('blog-list') }}" class="btn btn-white btn-dim btn-outline-light"><em class="d-none d-sm-inline icon ni ni-filter-alt"></em><span>Blog List</span><em class="dd-indc icon ni ni-chevron-right"></em></a></li>
                                                            ...
                                                            <ul class="nk-tb-actions gx-2">
                                                                @if($cat->status != 1)
                                                                    <li class="nk-tb-action-hidden">
                                                                        <a href="{{route('activate.blog.cat',$cat->id)}}" class="bg-white btn btn-sm btn-outline-light btn-icon" data-toggle="tooltip" data-placement="top" title="Enable"><em class="icon ni ni-done"></em></a>
                                                                    </li>
                                                                @else
                                                                    <li class="nk-tb-action-hidden">
                                                                        <a href="{{route('deactivate.blog.cat', $cat->id)}}" class="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" title="Disable"><em class="icon ni ni-cross-round"></em></a>
                                                                    </li>
                                                                @endif
                                                                <li>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt">
                                                                                @if($cat->status != 1)
                                                                                    <li><a href="{{route('activate.blog.cat',$cat->id)}}"><em class="icon ni ni-done"></em><span>Enable</span></a></li>
                                                                                @else
                                                                                    <li><a href="{{route('deactivate.blog.cat', $cat->id)}}"><em class="icon ni ni-cross-round"></em><span>Disable</span></a></li>
                                                                                @endif
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{route('create.blog.cat')}}" class="form-validate is-alter">
                                {{ csrf_field() }}
                        ...
                        <div class="modal-footer bg-light">
                            <span class="sub-text">Add New Blog Category</span>
                        </div>
                    </div>
                </div>
            </div>
