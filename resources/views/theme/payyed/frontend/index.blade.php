...
<div id="content">
    ...
    <div class="owl-carousel owl-theme single-slideshow" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
      <div class="item">
        <section class="hero-wrap">
          ...
          <div class="hero-bg" style="background-image:url('/{{$basic->theme}}/images/bg/image-1.jpg');"></div>
          <div class="hero-content d-flex fullscreen-with-header py-5">
            <div class="container my-auto text-center">
              ...
              <a href="index.html#" class="btn btn-primary m-2">Open a Free Account</a> <a class="btn btn-outline-light video-btn m-2" href="index.html#" data-src="https://www.youtube.com/embed/7e90gBu4pas" data-toggle="modal" data-target="#videoModal"><span class="text-2 mr-3"><i class="fas fa-play"></i></span>See How it Works</a> </div>
          </div>
        </section>
      </div>
      <div class="item">
        <section class="hero-wrap">
          <div class="hero-bg" style="background-image:url('/{{$basic->theme}}/images/bg/image-3.jpg');"></div>
          <div class="hero-content d-flex fullscreen-with-header py-5">
            <div class="container my-auto">
              <div class="row">
                <div class="col-12 col-lg-8 col-xl-7 text-center text-lg-left">
                  ...
                  <a href="index.html#" class="btn btn-primary mr-3">Get started for free</a> <a class="btn btn-link text-light video-btn" href="index.html#" data-src="https://www.youtube.com/embed/7e90gBu4pas" data-toggle="modal" data-target="#videoModal"><span class="mr-2"><i class="fas fa-play-circle"></i></span>Watch Demo</a> </div>
              </div>
            </div>
          </div>
        </section>
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
            <div class="featured-box">
              ...
              <a href="index.html#" class="btn-link text-3">Learn more<i class="fas fa-chevron-right text-1 ml-2"></i></a> </div>
          </div>
          <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
            <div class="featured-box">
        ...
        <div class="row">
          <div class="col-lg-5 col-xl-6 d-flex">
            <div class="my-auto pb-5 pb-lg-0">
              ...
              <a href="index.html#" class="btn-link text-4">Find more solution<i class="fas fa-chevron-right text-2 ml-2"></i></a> </div>
          </div>
          <div class="col-lg-7 col-xl-6">
            <div class="row banner style-2 justify-content-center">
              <div class="col-12 col-sm-6 mb-4 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="index.html#">
                  <div class="caption rounded-bottom">
                    <h2 class="text-5 font-weight-400 mb-0">Freelancer</h2>
                  </div>
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="/{{$basic->theme}}/images/anyone-freelancer.jpg" width="410" height="350"  alt="banner"> </a> </div>
              </div>
              <div class="col-12 col-sm-6 mb-4 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="index.html#">
                  <div class="caption rounded-bottom">
                  ...
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="/{{$basic->theme}}/images/anyone-online-shopping.jpg" width="410" height="350"  alt="banner"> </a> </div>
              </div>
              <div class="col-12 col-sm-6 mb-4 mb-sm-0 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="index.html#">
                  ...
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="/{{$basic->theme}}/images/anyone-online-sellers.jpg" width="410" height="350"  alt="banner"> </a> </div>
              </div>
              <div class="col-12 col-sm-6 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="index.html#">
                  ...
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="/{{$basic->theme}}/images/anyone-affiliate-marketing.jpg" width="410" height="350" alt="banner"> </a> </div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section bg-white">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-3 mb-4"> <a href="index.html#">
        ...
        <div class="text-center mt-4"><a href="index.html#" class="btn-link text-4">See more can you do<i class="fas fa-chevron-right text-2 ml-2"></i></a></div>
      </div>
    </section>
    <!-- What can you do end -->
    ...
    <section class="section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="card bg-dark-3 shadow-sm border-0"> <img class="card-img opacity-8" src="/{{$basic->theme}}/images/how-work.jpg" width="570" height="362"  alt="banner">
              <div class="card-img-overlay p-0"> <a class="d-flex h-100 video-btn" href="index.html#" data-src="https://www.youtube.com/embed/7e90gBu4pas" data-toggle="modal" data-target="#videoModal"> <span class="btn-video-play bg-white shadow-md rounded-circle m-auto"><i class="fas fa-play"></i></span> </a> </div>
            </div>
          </div>
          <div class="col-lg-6 mt-5 mt-lg-0">
            <div class="ml-4">
              ...
              <a href="index.html#" class="btn btn-outline-primary shadow-none mt-2">Open a Free Account</a> </div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section bg-white">
      <div class="container">
        ...
        <div class="text-center mt-4"><a href="index.html#" class="btn-link text-4">See more people review<i class="fas fa-chevron-right text-2 ml-2"></i></a></div>
      </div>
    </section>
    <!-- Testimonial end -->
    ...
    <section class="hero-wrap section shadow-md">
      ...
      <div class="hero-content py-5">
        <div class="container text-center">
          ...
          <a href="index.html#" class="btn btn-light">Find out more</a> </div>
      </div>
    </section>
    ...
    <section class="section py-5">
      <div class="container">
        <div class="justify-content-center text-center">
          ...
          <a class="d-inline-flex mx-3" href="index.html#"><img alt="" width="168" height="49"  src="/{{$basic->theme}}/images/app-store.png"></a> <a class="d-inline-flex mx-3" href="index.html#"><img alt="" width="166" height="49"  src="/{{$basic->theme}}/images/google-play-store.png"></a> </div>
      </div>
    </section>
    <!-- Mobile App end -->
</div>
