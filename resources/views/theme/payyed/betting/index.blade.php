                ...
                <div class="row">
                    <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
                        <div class="bg-white shadow-sm rounded p-3 pt-sm-5 pb-sm-5 px-sm-5 mb-4">
                            ...
                            <!-- Deposit Money Form
                    ============================================= -->
                            <form id="form-send-money" method="POST" action="{{ route('validate-betting') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="paymentMethod">Betting Provider</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="number" class="form-control" data-bv-field="amount" id="number" autocomplete="offInput" required placeholder="User ID...">
                                </div>
                                <div class="form-group">
