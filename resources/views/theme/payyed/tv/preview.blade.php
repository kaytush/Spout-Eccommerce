            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    ============================================= -->
                            ...
                            @endif
                            <form id="form-send-money" action="{{route('buy-tv')}}" method="POST">
                                ...
                                <div class="alert alert-info rounded shadow-sm py-3 px-4 px-sm-2 mb-5">
                                    ...
                                    <div class="form-row align-items-center">
                                        <p class="col-sm-5 opacity-7 text-sm-right mb-0 mb-sm-3">Bouquet:</p>
                                        <p class="col-sm-7 text-3">{{$bouquet->name}}</p>
                                    </div>
                                    {{-- <div class="form-row align-items-center">
                                ...
                                <p class="mb-1">Bouquet Amount <span class="text-3 float-right">{{$basic->currency_sym.number_format($amount,$basic->decimal)}}</span></p>
