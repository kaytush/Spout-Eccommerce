            ...
            <div class="container">
                ...
                ============================================= -->
                        <div class="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
                            ...
                            <p class="text-3 mb-4">You've successfully purchased <span class="text-4 font-weight-500">{{session('name')}}</span> Tv Subscription on <span class="text-4 font-weight-500">{{session('number')}}</span>, See transaction details in <a class="btn-link" href="{{route('transactions')}}">Transaction History</a>.</p>
                            <a href="{{route('internet')}}" data-turbo="false" class="btn btn-primary btn-block">Purchase Tv Sub Again</a>
