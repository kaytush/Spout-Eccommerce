...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
                        <div class="bg-white shadow-sm rounded p-3 pt-sm-5 pb-sm-5 px-sm-5 mb-4">
                            ...
                            <!-- Deposit Money Form
                    ============================================= -->
                            <form id="form-send-money" method="POST" action="{{ route('validate-tv') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="paymentMethod">Tv Provider</label>
                                ...
                                <div class="form-group">
                                    <label for="inputCountry">Bouquet</label>
                                ...
                                <div class="form-group">
                                    <label for="number" id="iuc">Smartcard/IUC Number</label>
                                    <input type="number" name="number" class="form-control" data-bv-field="amount" id="number" autocomplete="offInput" minlength="10" maxlength="11" placeholder="Smartcard/IUC Number" onkeyup="verify(this.value)" required>
                                </div>
                                <p class="text-muted mt-4">
                                    Account Name <span class="float-right d-flex align-items-center"><span id="decodername">-</span></span>
                                </p>
                                <p class="text-muted mt-4">
        ...
        <script>
            ...
            function chooseType(id) {
                if(id == 'DSTV'){
                    document.getElementById("iuc").innerHTML = "DStv Smartcard Number";
                    document.getElementById("number").placeholder = "DStv Smartcard Number";
                }else if(id == 'GOTV'){
                    document.getElementById("iuc").innerHTML = "GOtv IUC Number";
                    document.getElementById("number").placeholder = "GOtv IUC Number";
                }else if(id == 'STARTIMES'){
                    document.getElementById("iuc").innerHTML = "Startimes Smartcard /ewallet Number";
                    document.getElementById("number").placeholder = "Startimes Smartcard /ewallet Number";
                }else if(id == 'SHOWMAX'){
                    document.getElementById("iuc").innerHTML = "Phone Number";
                    document.getElementById("number").placeholder = "Phone Number";
                }
            ...
            function verify(number) {
                ...
                if(provider != "SHOWMAX"){
                    if (number.length > 9) {
                        document.getElementById("show").innerHTML = "Verifying....";
                        document.getElementById("show").disabled = true;
                        ...
                        xmlhttp.onreadystatechange = function() {
                            if (this.readyState == 4 && this.status == 200) {
                                ...
                                if(jRes.success){
                                    ...
                                    document.getElementById("decodername").innerHTML = "-";
                                    document.getElementById("show").innerHTML = "Continue";
                                    document.getElementById("show").disabled = false;
                                }
                            }
                        };
                        xmlhttp.open("GET", "/tv/validate/"+provider+"/"+number, true);
                        xmlhttp.send();
                    }else {
                        document.getElementById("decodername").innerHTML = "-";
                    }
                }else{
                    document.getElementById("decodername").innerHTML = number;
                }
