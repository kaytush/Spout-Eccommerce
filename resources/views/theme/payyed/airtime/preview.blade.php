            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
                        <div class="bg-white shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
                            <div class="text-center">
                                <img style="border-radius: 20px" src="{{url($topup->providerLogoUrl)}}" width="80px" height="80px" alt="avatar">
                            </div>
                    ...
                    ============================================= -->
                            ...
                            @endif
                            <form id="form-send-money" action="{{route('buy-airtime')}}" method="POST">
                                ...
                                <hr class="mx-n3 mx-sm-n5 mb-4" />
                                <p class="mb-1">Airtime Value <span class="text-3 float-right">{{$basic->currency_sym.number_format($amount,$basic->decimal)}}</span></p>
